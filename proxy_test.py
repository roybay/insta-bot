...
ip1 = requests.get('http://api.ipify.org?format=json').text
print("Before Proxy IP Address is:" + str(ip1))
ip2 = requests.get('http://api.ipify.org?format=json', proxies=proxy.Config).text
print("After Proxy  IP Address is:" + str(ip2))
